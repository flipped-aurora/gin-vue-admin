...
var menus = []model.SysBaseMenu{
	...
	{GVA_MODEL: global.GVA_MODEL{ID: 22, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, ParentId: "0", Path: "https://www.github.com/eyotang/gin-vue-admin/server.com", Name: "https://www.github.com/eyotang/gin-vue-admin/server.com", Hidden: false, Component: "/", Sort: 0, Meta: model.Meta{Title: "官方网站", Icon: "s-home"}},
