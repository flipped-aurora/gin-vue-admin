<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="尺码表id" prop="sizeID" width="120" />
        <el-table-column align="left" label="工序id" prop="processID" width="120" />
        <el-table-column align="left" label="总量" prop="total" width="120" />
        <el-table-column align="left" label="余量" prop="margin" width="120" />
