...
CREATE TABLE `cate_menus` (
  ...
  `mode_type` tinyint(4) DEFAULT NULL COMMENT '模型管理 1 产品管理 2 文章管理',
  `cate_type` mediumint(9) DEFAULT NULL COMMENT '栏目类型 1 封面 2 列表 3 链接',
  ...
  `order_type` tinyint(4) DEFAULT '1' COMMENT '排序方式 1 升序 2 降序',
...
(1,'2024-03-20 11:40:40.961','2024-03-20 11:40:40.961',NULL,'10.png','https://qmplusimg.henrongyi.top/gvalogo.png','png','158787308910.png'),
(2,'2024-03-20 11:40:40.961','2024-03-20 11:40:40.961',NULL,'logo.png','https://qmplusimg.henrongyi.top/1576554439myAvatar.png','png','1587973709logo.png');
