<template>
    <div>
        <el-button type="primary" class="upload-btn-media-library" @click="dialogFormVisible = !dialogFormVisible">大文件上传</el-button>
        ...
        <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="弹窗操作">
            ...
            <div class="gva-table-box">
                ...
                <div class="el-upload__tip">请上传不超过500MB的文件</div>
                <div class="list">
  ...
  const upLoadFileSlice = async(item) => {
    ...
    if (waitNum.value === 0) {
      ...
      if (res.code === 0) {
        ...
        emit('on-success',res.data.filePath)
      }
    }
  }
