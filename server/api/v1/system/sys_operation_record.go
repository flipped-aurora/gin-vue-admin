...
// @Success 200 {object} response.Response{msg="创建成功"} "创建SysOperationRecord"
...
// @Success 200 {object} response.Response{msg="删除成功"} "删除SysOperationRecord"
...
// @Success 200 {object} response.Response{msg="批量删除成功"} "批量删除SysOperationRecord"
...
// @Success 200 {object} response.Response{data=gin.H,msg="查询成功"} "用id查询SysOperationRecord"
...
// @Success 200 {object} response.Response{data=response.PageResult,msg="获取成功"} "分页获取SysOperationRecord列表,返回包括列表,总数,页码,每页数量"
