...
// @Success 200 {object} response.Response{data=gin.H,msg="获取成功"} "获取meta信息"
...
// @Produce application/json
// @Param data body request.GetById true "请求参数"
// @Success 200 {object} response.Response{msg="删除成功"} "删除回滚记录"
...
// @Produce application/json
// @Param data body request.GetById true "请求参数"
// @Success 200 {object} response.Response{msg="回滚成功"} "回滚自动生成代码"
...
// @Success 200 {object} response.Response{data=response.PageResult,msg="获取成功"} "查询回滚记录,返回包括列表,总数,页码,每页数量"
