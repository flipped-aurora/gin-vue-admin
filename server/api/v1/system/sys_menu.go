...
// @Success 200 {object} response.Response{data=systemRes.SysMenusResponse,msg="获取成功"} "获取用户动态路由,返回包括系统菜单详情列表"
...
// @Produce  application/json
// @Param data body request.Empty true "空"
// @Success 200 {object} response.Response{data=systemRes.SysBaseMenusResponse,msg="获取成功"} "获取用户动态路由,返回包括系统菜单列表"
...
// @Success 200 {object} response.Response{msg="添加成功"} "增加menu和角色关联关系"
...
// @Success 200 {object} response.Response{data=gin.H,msg="获取成功"} "获取指定角色menu"
...
// @Success 200 {object} response.Response{msg="添加成功"} "新增菜单"
...
// @Success 200 {object} response.Response{msg="删除成功"} "删除菜单"
...
// @Produce application/json
// @Param data body system.SysBaseMenu true "路由path, 父菜单ID, 路由name, 对应前端文件路径, 排序标记"
// @Success 200 {object} response.Response{msg="更新成功"} "更新菜单"
...
// @Produce application/json
// @Param data body request.GetById true "菜单id"
// @Success 200 {object} response.Response{data=systemRes.SysBaseMenuResponse,msg="获取成功"} "根据id获取菜单,返回包括系统菜单列表"
...
// @Success 200 {object} response.Response{data=response.PageResult,msg="获取成功"} "分页获取基础menu列表,返回包括列表,总数,页码,每页数量"
