...
func AutoInjectionCode(filepath string, funcName string, codeData string) error {
	startComment := "Code generated by github.com/eyotang/game-proxy/server Begin; DO NOT EDIT."
	endComment := "Code generated by github.com/eyotang/game-proxy/server End; DO NOT EDIT."
