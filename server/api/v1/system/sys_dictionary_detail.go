...
// @Success 200 {object} response.Response{msg="创建成功"} "创建SysDictionaryDetail"
...
// @Produce application/json
// @Param data body system.SysDictionaryDetail true "SysDictionaryDetail模型"
// @Success 200 {object} response.Response{msg="删除成功"} "删除SysDictionaryDetail"
...
// @Success 200 {object} response.Response{msg="更新成功"} "更新SysDictionaryDetail"
...
// @Success 200 {object} response.Response{data=gin.H,msg="查询成功"} "用id查询SysDictionaryDetail"
...
// @Success 200 {object} response.Response{data=response.PageResult,msg="获取成功"} "分页获取SysDictionaryDetail列表,返回包括列表,总数,页码,每页数量"
