...
func (d *dictionaryDetail) Initialize() error {
	...
	*status = true
	entities := []system.SysDictionaryDetail{
		{Label: global.Translate("system.dictionary_detail.male"), Value: 1, Status: status, Sort: 1, SysDictionaryID: 1},
		{Label: global.Translate("system.dictionary_detail.female"), Value: 2, Status: status, Sort: 2, SysDictionaryID: 1},
