      ...
      <el-tabs v-model="activeNames">
        ...
        >
          ...
          >
            <el-form-item :label="t('view.systemTools.system.globalRoutePrefix')">
              <el-input v-model.trim="config.system['router-prefix']" :placeholder="t('view.systemTools.system.globalRoutePerfixNote2')"/>
            </el-form-item>
          </el-tooltip>
        </el-tab-pane>
        <el-tab-pane
        ...
        >
          <el-form-item :label="t('view.systemTools.system.level')">
            <el-select v-model="config.zap.level">
              <el-option value="off" :label="t('view.systemTools.system.off')"/>
              <el-option value="fatal" :label="t('view.systemTools.system.fatal')"/>
              <el-option value="error" :label="t('view.systemTools.system.error')"/>
              <el-option value="warn" :label="t('view.systemTools.system.warn')"/>
              <el-option value="info" :label="t('view.systemTools.system.info')"/>
          ...
          <el-form-item :label="t('view.systemTools.system.logPrefix')">
            <el-input v-model.trim="config.zap.prefix" :placeholder="t('view.systemTools.system.logPrefixNote')"/>
          </el-form-item>
          <el-form-item :label="t('view.systemTools.system.logFolder')">
            <el-input v-model.trim="config.zap.director" :placeholder="t('view.systemTools.system.logFolderNote')"/>
          </el-form-item>
          ...
          <el-form-item :label="t('view.systemTools.system.stackName')">
            <el-input v-model.trim="config.zap['stacktrace-key']" :placeholder="t('view.systemTools.system.stackNameNote')"/>
          </el-form-item>
        ...
        >
          ...
          <el-form-item :label="t('view.systemTools.system.address')">
            <el-input v-model.trim="config.redis.addr" :placeholder="t('view.systemTools.system.addressNote')"/>
          </el-form-item>
          <el-form-item :label="t('view.systemTools.system.password')">
            <el-input v-model.trim="config.redis.password" :placeholder="t('view.systemTools.system.passwordNote')"/>
          </el-form-item>
        </el-tab-pane>
        <el-tab-pane
        ...
        >
          ...
          <el-form-item :label="t('view.systemTools.system.emailSender')">
            <el-input v-model.trim="config.email.from" :placeholder="t('view.systemTools.system.emailSenderNote')" />
          </el-form-item>
          <el-form-item label="Host">
            <el-input v-model.trim="config.email.host" :placeholder="t('view.systemTools.system.hostNote')" />
          </el-form-item>
          <el-form-item :label="t('view.systemTools.system.enableSSL')">
            <el-switch v-model="config.email['is-ssl']" />
          </el-form-item>
          <el-form-item label="Secret">
            <el-input v-model.trim="config.email.secret" :placeholder="t('view.systemTools.system.secretNote')"/>
          </el-form-item>
        ...
        >
          ...
          <el-form-item :label="t('view.systemTools.system.userName')">
            <el-input v-model.trim="config.mongo.username" :placeholder="t('view.systemTools.system.userNameNote')"/>
          </el-form-item>
          <el-form-item :label="t('view.systemTools.system.password')">
            <el-input v-model.trim="config.mongo.password" :placeholder="t('view.systemTools.system.passwordNote')"/>
          </el-form-item>
        ...
        >
          <template v-if="config.system['db-type'] === 'mysql'">
            ...
            <el-form-item :label="t('view.systemTools.system.userName')">
              <el-input v-model.trim="config.mysql.username" :placeholder="t('view.systemTools.system.userNameNote')"/>
            </el-form-item>
            <el-form-item :label="t('view.systemTools.system.password')">
              <el-input v-model.trim="config.mysql.password" :placeholder="t('view.systemTools.system.passwordNote')"/>
            </el-form-item>
            <el-form-item :label="t('view.systemTools.system.address')">
              <el-input v-model.trim="config.mysql.path" :placeholder="t('view.systemTools.system.addressNote')"/>
            </el-form-item>
            <el-form-item :label="t('view.systemTools.system.dbName')">
              <el-input v-model.trim="config.mysql['db-name']" :placeholder="t('view.systemTools.system.dbNameNote')"/>
            </el-form-item>
            ...
            <el-form-item :label="t('view.systemTools.system.engine')">
              <el-input v-model.trim="config.mysql['engine']" :placeholder="t('view.systemTools.system.engineNote')"/>
            </el-form-item>
          ...
          <template v-if="config.system['db-type'] === 'pgsql'">
            ...
            <el-form-item :label="t('view.systemTools.system.userName')">
              <el-input v-model="config.pgsql.username" :placeholder="t('view.systemTools.system.userNameNote')"/>
            </el-form-item>
            <el-form-item :label="t('view.systemTools.system.password')">
              <el-input v-model="config.pgsql.password" :placeholder="t('view.systemTools.system.passwordNote')"/>
            </el-form-item>
            <el-form-item :label="t('view.systemTools.system.address')">
              <el-input v-model.trim="config.pgsql.path" :placeholder="t('view.systemTools.system.addressNote')"/>
            </el-form-item>
            <el-form-item :label="t('view.systemTools.system.dbName')">
              <el-input v-model.trim="config.pgsql['db-name']" :placeholder="t('view.systemTools.system.dbNametNote')"/>
            </el-form-item>
            <el-form-item :label="t('view.systemTools.system.prefix')">
              <el-input v-model.trim="config.pgsql['prefix']" :placeholder="t('view.systemTools.system.prefixNote')"/>
            </el-form-item>
            <el-form-item :label="t('view.systemTools.system.pluralTable')">
              <el-switch v-model="config.pgsql['singular']"/>
            </el-form-item>
            <el-form-item :label="t('view.systemTools.system.engine')">
              <el-input v-model.trim="config.pgsql['engine']" :placeholder="t('view.systemTools.system.engineNote2')"/>
            </el-form-item>
            <el-form-item :label="t('view.systemTools.system.maxIdleConns')">
          ...
          <template v-if="config.system['db-type'] === 'mssql'">
            ...
            <el-form-item :label="t('view.systemTools.system.userName')">
              <el-input v-model.trim="config.mssql.username" :placeholder="t('view.systemTools.system.userNameNote')"/>
            </el-form-item>
            <el-form-item :label="t('view.systemTools.system.password')">
              <el-input v-model.trim="config.mssql.password" :placeholder="t('view.systemTools.system.passwordNote')"/>
            </el-form-item>
            <el-form-item :label="t('view.systemTools.system.address')">
              <el-input v-model.trim="config.mssql.path" :placeholder="t('view.systemTools.system.addressNote')"/>
            </el-form-item>
            <el-form-item :label="t('view.systemTools.system.port')">
              <el-input v-model.trim="config.mssql.port" :placeholder="t('view.systemTools.system.portNote2')"/>
            </el-form-item>
            <el-form-item :label="t('view.systemTools.system.dbName')">
              <el-input v-model.trim="config.mssql['db-name']" :placeholder="t('view.systemTools.system.dbNametNote')"/>
            </el-form-item>
            <el-form-item :label="t('view.systemTools.system.prefix')">
              <el-input v-model.trim="config.mssql['prefix']" :placeholder="t('view.systemTools.system.prefixNote')"/>
            </el-form-item>
            <el-form-item :label="t('view.systemTools.system.pluralTable')">
              <el-switch v-model="config.mssql['singular']"/>
            </el-form-item>
            <el-form-item :label="t('view.systemTools.system.engine')">
              <el-input v-model.trim="config.mssql['engine']" :placeholder="t('view.systemTools.system.engineNote2')"/>
            </el-form-item>
            <el-form-item :label="t('view.systemTools.system.maxIdleConns')">
          ...
          <template v-if="config.system['db-type'] === 'sqlite'">
            ...
            <el-form-item :label="t('view.systemTools.system.userName')">
              <el-input v-model.trim="config.sqlite.username" :placeholder="t('view.systemTools.system.userNameNote')"/>
            </el-form-item>
            <el-form-item :label="t('view.systemTools.system.password')">
              <el-input v-model.trim="config.sqlite.password" :placeholder="t('view.systemTools.system.passwordNote')"/>
            </el-form-item>
            <el-form-item :label="t('view.systemTools.system.address')">
              <el-input v-model.trim="config.sqlite.path" :placeholder="t('view.systemTools.system.addressNote')"/>
            </el-form-item>
            <el-form-item :label="t('view.systemTools.system.port')">
              <el-input v-model.trim="config.sqlite.port" :placeholder="t('view.systemTools.system.portNote2')"/>
            </el-form-item>
            <el-form-item :label="t('view.systemTools.system.dbName')">
              <el-input v-model.trim="config.sqlite['db-name']" :placeholder="t('view.systemTools.system.dbNametNote')"/>
            </el-form-item>
            <el-form-item :label="t('view.systemTools.system.maxIdleConns')">
          ...
          <template v-if="config.system['db-type'] === 'oracle'">
            ...
            <el-form-item :label="t('view.systemTools.system.userName')">
              <el-input v-model.trim="config.oracle.username" :placeholder="t('view.systemTools.system.userNameNote')"/>
            </el-form-item>
            <el-form-item :label="t('view.systemTools.system.password')">
              <el-input v-model.trim="config.oracle.password" :placeholder="t('view.systemTools.system.passwordNote')"/>
            </el-form-item>
            <el-form-item :label="t('view.systemTools.system.address')">
              <el-input v-model.trim="config.oracle.path" :placeholder="t('view.systemTools.system.addressNote')"/>
            </el-form-item>
            <el-form-item label="数据库名称">
              <el-input v-model.trim="config.oracle['db-name']" :placeholder="t('view.systemTools.system.dbNameNote')"/>
            </el-form-item>
            <el-form-item :label="t('view.systemTools.system.prefix')">
            ...
            <el-form-item :label="t('view.systemTools.system.engine')">
              <el-input v-model.trim="config.oracle['engine']" :placeholder="t('view.systemTools.system.engineNote')"/>
            </el-form-item>
            <el-form-item :label="t('view.systemTools.system.maxIdleConns')">
        ...
        >
          <template v-if="config.system['oss-type'] === 'local'">
            ...
            <el-form-item :label="t('view.systemTools.system.localFilePath')">
              <el-input v-model.trim="config.local.path" :placeholder="t('view.systemTools.system.localFilePathNote')"/>
            </el-form-item>
            <el-form-item :label="t('view.systemTools.system.localFileStoragePath')">
              <el-input v-model.trim="config.local['store-path']" :placeholder="t('view.systemTools.system.localFileStoragePathNote')"/>
            </el-form-item>
          </template>
        ...
        >
          <el-form-item :label="t('view.systemTools.system.excelDir')">
            <el-input v-model.trim="config.excel.dir" :placeholder="t('view.systemTools.system.excelDirNote')" />
          </el-form-item>
        </el-tab-pane>
        <el-tab-pane
        ...
        >
          ...
          <el-form-item :label="t('view.systemTools.system.backendCodePath')">
            <el-input v-model.trim="config.autocode['server']" :placeholder="t('view.systemTools.system.backendCodePathNote')"/>
          </el-form-item>
          <el-form-item :label="t('view.systemTools.system.backendApiPath')">
            <el-input v-model.trim="config.autocode['server-api']" :placeholder="t('view.systemTools.system.backendApiPathNote')"/>
          </el-form-item>
          <el-form-item :label="t('view.systemTools.system.backendInitPath')">
            <el-input v-model.trim="config.autocode['server-initialize']" :placeholder="t('view.systemTools.system.backendInitPathNote')"/>
          </el-form-item>
          <el-form-item :label="t('view.systemTools.system.backendModelPath')">
            <el-input v-model.trim="config.autocode['server-model']" :placeholder="t('view.systemTools.system.backendModelPathNote')"/>
          </el-form-item>
          <el-form-item :label="t('view.systemTools.system.backendRequestPath')">
            <el-input v-model.trim="config.autocode['server-request']" :placeholder="t('view.systemTools.system.backendRequestPathNote')"/>
          </el-form-item>
          <el-form-item :label="t('view.systemTools.system.backendRouterPath')">
            <el-input v-model.trim="config.autocode['server-router']" :placeholder="t('view.systemTools.system.backendRouterPathNote')"/>
          </el-form-item>
          <el-form-item :label="t('view.systemTools.system.backendServicePath')">
            <el-input v-model.trim="config.autocode['server-service']" :placeholder="t('view.systemTools.system.backendServicePathNote')"/>
          </el-form-item>
          <el-form-item :label="t('view.systemTools.system.frontendCodePath')">
            <el-input v-model.trim="config.autocode.web" :placeholder="t('view.systemTools.system.frontendCodePathNote')"/>
          </el-form-item>
          <el-form-item :label="t('view.systemTools.system.frontendApiPath')">
            <el-input v-model.trim="config.autocode['web-api']" :placeholder="t('view.systemTools.system.frontendApiPathNote')"/>
          </el-form-item>
          <el-form-item :label="t('view.systemTools.system.frontendFormPath')">
            <el-input v-model.trim="config.autocode['web-form']" :placeholder="t('view.systemTools.system.frontendFormPathNote')"/>
          </el-form-item>
          <el-form-item :label="t('view.systemTools.system.frontendTablePath')">
            <el-input v-model.trim="config.autocode['web-table']" :placeholder="t('view.systemTools.system.frontendTablePathNote')"/>
          </el-form-item>
        </el-tab-pane>
        <el-tab-pane
...
const reload = () => {
  ElMessageBox.confirm(
      t('view.systemTools.system.restartServiceConfirm'),
      t('general.warning'),
      {
