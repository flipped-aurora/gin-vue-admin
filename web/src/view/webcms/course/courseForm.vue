  ...
  <div>
    <div class="gva-form-box">
      <el-form :model="formData" ref="elFormRef" label-position="right" :rules="rule" label-width="80px">
        ...
        <el-form-item label="课程图片:" prop="courseThumb">
          <el-input v-model="formData.courseThumb" :clearable="true" placeholder="请输入" />
        </el-form-item>
        <el-form-item label="课程等级:" prop="courseLevel">
          <el-switch v-model="formData.courseLevel" active-color="#13ce66" inactive-color="#ff4949" active-text="是" inactive-text="否" clearable ></el-switch>
        </el-form-item>
        <el-form-item label="课程价格:" prop="coursePrice">
          <el-input-number v-model="formData.coursePrice" :precision="2" :clearable="true"></el-input-number>
        </el-form-item>
        ...
        <el-form-item label="购买数量:" prop="purchaseCnt">
          <el-input v-model.number="formData.purchaseCnt" :clearable="true" placeholder="请输入" />
        </el-form-item>
        <el-form-item>
