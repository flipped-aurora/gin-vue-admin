...
//	@accept		application/json
//	@Produce	application/json
//	@Param		data	body		systemReq.AuthorityCopy			true	"旧角色id, 新权限id, 新权限名, 新父角色id"
//	@Success	200		{object}	response.Response{msg=string}	"拷贝角色,返回包括系统角色详情"
//	@Router		/authority/copyAuthority [post]
func (a *AuthorityApi) CopyAuthority(c *gin.Context) {
	var info systemReq.AuthorityCopy
	...
	err = utils.Verify(info.Authority, utils.AuthorityVerify)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
		return
	}
	err = authorityService.Copy(c.Request.Context(), info)
	if err != nil {
