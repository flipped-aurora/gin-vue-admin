...
// @Success 200 {object} response.Response{msg="更新成功"} "更新角色api权限"
...
// @Produce application/json
// @Param data body request.CasbinInReceive true "权限id, 权限模型列表"
// @Success 200 {object} response.Response{data=systemRes.PolicyPathResponse,msg="获取成功"} "获取权限列表,返回包括casbin详情列表"
