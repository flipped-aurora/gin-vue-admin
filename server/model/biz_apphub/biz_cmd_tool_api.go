...
// 后端工具指令api 结构体  BizCmdToolApi
type BizCmdToolApi struct {
	global.GVA_MODEL
...
// TableName 后端工具指令api BizCmdToolApi自定义表名 biz_cmd_tool_api
func (BizCmdToolApi) TableName() string {
	return "biz_cmd_tool_api"
}
