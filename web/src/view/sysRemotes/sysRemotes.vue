<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="机器简称" prop="name" width="120" />
        <el-table-column align="left" label="项目编号" prop="code" width="120" />
        <el-table-column align="left" label="状态" prop="status" width="120">
            <template #default="scope">{{ formatBoolean(scope.row.status) }}</template>
        </el-table-column>
        <el-table-column align="left" label="删除状态" prop="isRemoved" width="120">
        ...
        <el-table-column align="left" label="操作">
            ...
            <el-button type="primary" link icon="edit" class="table-button" @click="updateSysRemotesFunc(scope.row)">变更</el-button>
