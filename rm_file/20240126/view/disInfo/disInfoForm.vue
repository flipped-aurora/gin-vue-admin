    ...
    <div class="gva-form-box">
      <el-form :model="formData" ref="elFormRef" label-position="right" :rules="rule" label-width="80px">
        ...
        <el-form-item label="帖子关联比赛id:" prop="disComId">
          <el-input v-model.number="formData.disComId" :clearable="true" placeholder="请输入" />
       </el-form-item>
        <el-form-item label="发帖人id:" prop="disUserId">
          <el-input v-model.number="formData.disUserId" :clearable="true" placeholder="请输入" />
       </el-form-item>
        <el-form-item label="帖子点赞人数:" prop="disLoveNumber">
          <el-input v-model.number="formData.disLoveNumber" :clearable="true" placeholder="请输入" />
       </el-form-item>
        <el-form-item label="帖子收藏人数:" prop="disCollectNumber">
          <el-input v-model.number="formData.disCollectNumber" :clearable="true" placeholder="请输入" />
       </el-form-item>
        <el-form-item label="帖子类型:" prop="disModel">
          <el-select v-model="formData.disModel" placeholder="请选择" :clearable="true">
