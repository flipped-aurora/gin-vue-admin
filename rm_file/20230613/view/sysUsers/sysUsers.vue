<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="sideMode字段" prop="sideMode" width="120" />
        <el-table-column align="left" label="headerImg字段" prop="headerImg" width="120" />
        <el-table-column align="left" label="baseColor字段" prop="baseColor" width="120" />
        <el-table-column align="left" label="activeColor字段" prop="activeColor" width="120" />
        <el-table-column align="left" label="authorityId字段" prop="authorityId" width="120" />
        <el-table-column align="left" label="phone字段" prop="phone" width="120" />
        <el-table-column align="left" label="email字段" prop="email" width="120" />
        <el-table-column align="left" label="enable字段" prop="enable" width="120" />
