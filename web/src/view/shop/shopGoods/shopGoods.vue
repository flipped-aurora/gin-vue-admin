  ...
  <div>
    <div class="gva-search-box">
      <el-form ref="elSearchFormRef" :inline="true" :model="searchInfo" class="demo-form-inline" :rules="searchRule"
        ...
        <el-form-item label="店铺ID" prop="goodsShopid">
          <el-input v-model="searchInfo.goodsShopid" placeholder="搜索条件" />

        </el-form-item>
        <el-form-item label="设备ID" prop="goodsMacid">
          <el-input v-model="searchInfo.goodsMacid" placeholder="搜索条件" />
        ...
        <el-form-item label="商品状态" prop="goodsStatus">
          <el-select v-model="searchInfo.goodsStatus" clearable placeholder="请选择"
            @clear="() => { searchInfo.goodsStatus = undefined }">
    ...
    <div class="gva-table-box">
      ...
      <el-table ref="multipleTable" style="width: 100%" tooltip-effect="dark" :data="tableData" row-key="ID"
        ...
        <el-table-column align="left" label="店铺ID" prop="goodsShopid" width="120" />
        <el-table-column align="left" label="设备ID" prop="goodsMacid" width="120" />
        <el-table-column align="left" label="商品名称" prop="goodsName" width="120" />
        <el-table-column align="left" label="商品描述" prop="goodsDesc" width="220"/>
        <el-table-column align="left" label="商品价格" prop="goodsPrice" width="120" />
        <el-table-column align="left" label="市场价" prop="goodsMaketPrice" width="120" />
        <el-table-column align="left" label="商品库存" prop="goodsStock" width="120" />
        <el-table-column align="left" label="图片链接" prop="goodsImg" width="180" />
        <el-table-column align="left" label="上架时间" width="180">
          <template #default="scope">{{ formatDate(scope.row.goodsSellTime) }}</template>
        </el-table-column>
        <el-table-column align="left" label="商品状态" prop="goodsStatus" width="120">
          <template #default="scope">
            {{ filterDict(scope.row.goodsStatus, itemStatusOptions) }}
          </template>
        </el-table-column>
        <el-table-column align="left" label="商品邮费" prop="goodsPostfee" width="120" />
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" :title="type === 'create' ? '添加' : '修改'"
      ...
      <el-scrollbar height="500px">
        <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
          <el-form-item label="店铺ID:" prop="goodsShopid">
            <el-input v-model="formData.goodsShopid" :clearable="true" placeholder="请输入店铺ID" />
          </el-form-item>
          <el-form-item label="设备ID:" prop="goodsMacid">
            <el-input v-model="formData.goodsMacid" :clearable="true" placeholder="请输入设备ID" />
          </el-form-item>
          <el-form-item label="商品名称:" prop="goodsName">
            <el-input v-model="formData.goodsName" :clearable="true" placeholder="请输入商品名称" />
          </el-form-item>
          <el-form-item label="商品描述:" prop="goodsDesc">
            <el-input v-model="formData.goodsDesc" :clearable="true" placeholder="请输入商品描述" />
          </el-form-item>
          ...
          <el-form-item label="市场价:" prop="goodsMaketPrice">
            <el-input v-model.number="formData.goodsMaketPrice" :clearable="true" placeholder="请输入市场价" />
          </el-form-item>
          <el-form-item label="商品库存:" prop="goodsStock">
            <el-input v-model.number="formData.goodsStock" :clearable="true" placeholder="请输入商品库存" />
          </el-form-item>
          <el-form-item label="图片链接:" prop="goodsImg">
            <el-input v-model="formData.goodsImg" :clearable="true" placeholder="请输入图片链接" />
          </el-form-item>
          <el-form-item label="上架时间:" prop="goodsSellTime">
            <el-date-picker v-model="formData.goodsSellTime" type="date" style="width:100%" placeholder="选择日期"
              :clearable="true" />
          </el-form-item>
          <el-form-item label="商品状态:" prop="goodsStatus">
            <el-select v-model="formData.goodsStatus" placeholder="请选择商品状态" style="width:100%" :clearable="true">
              <el-option v-for="(item, key) in itemStatusOptions" :key="key" :label="item.label" :value="item.value" />
            </el-select>
          </el-form-item>
          <el-form-item label="商品邮费:" prop="goodsPostfee">
            <el-input v-model.number="formData.goodsPostfee" :clearable="true" placeholder="请输入商品邮费" />
          </el-form-item>
        </el-form>
      </el-scrollbar>
      <template #footer>
      ...
      <el-scrollbar height="550px">
        <el-descriptions column="1" border>
          ...
          <el-descriptions-item label="上架时间">
            {{ formatDate(formData.goodsSellTime) }}
          </el-descriptions-item>
          <el-descriptions-item label="商品状态">
            {{ filterDict(formData.goodsStatus, itemStatusOptions) }}
          </el-descriptions-item>
          <el-descriptions-item label="商品邮费">
            {{ formData.goodsPostfee }}
          </el-descriptions-item>
        </el-descriptions>
      </el-scrollbar>
    </el-dialog>
