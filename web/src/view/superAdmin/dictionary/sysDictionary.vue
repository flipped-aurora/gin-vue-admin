<template>
  <div>
    ...
    <div class="flex gap-4 p-2">
      <div
        class="flex-none w-56 bg-white text-slate-700 dark:text-slate-400 dark:bg-slate-900 rounded p-4"
      >
    ...
    >
      ...
      >
        ...
        <el-form-item
          :label="t('view.dictionary.sysDictionary.dictDataType')"
          prop="type"
        >
          <el-input
            v-model="formData.type"
            :placeholder="t('view.dictionary.sysDictionary.enterDictDataType')"
            clearable
            :style="{ width: '100%' }"
          />
        </el-form-item>
