...
func AutoInjectionCode(filepath string, funcName string, codeData string) error {
	startComment := "Code generated by github.com/eyotang/gin-vue-admin/server Begin; DO NOT EDIT."
	endComment := "Code generated by github.com/eyotang/gin-vue-admin/server End; DO NOT EDIT."
