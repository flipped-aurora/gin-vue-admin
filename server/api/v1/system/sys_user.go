...
// @Success 200 {object} response.Response{data=systemRes.LoginResponse,msg="登录成功"} ",返回包括用户信息,token,过期时间"
...
// @Success 200 {object} response.Response{data=systemRes.SysUserResponse,msg="注册成功"} "用户注册账号,返回包括用户信息"
...
// @Success 200 {object} response.Response{msg="修改成功"} "用户修改密码"
...
// @Success 200 {object} response.Response{data=response.PageResult,msg="获取成功"} "分页获取用户列表,返回包括列表,总数,页码,每页数量"
...
// @Success 200 {object} response.Response{msg="修改成功"} "设置用户权限"
...
// @Success 200 {object} response.Response{msg="删除成功"} "删除用户"
...
// @Success 200 {object} response.Response{data=gin.H,msg="设置成功"} "设置用户信息"
...
// @accept application/json
// @Produce application/json
// @Success 200 {object} response.Response{data=gin.H,msg="获取成功"} "获取用户信息"
...
// @Success 200 {object} response.Response{msg="重置成功"} "用户修改密码"
