<template>
  <div class="flex justify-between items-center gap-2 w-full">
    <el-cascader
        v-if="pathIsSelect"
        :placeholder="t('view.superAdmin.menu.components.componentsCascader.selectFilePathNote')"
        :options="pathOptions"
        ...
        @change="emitChange"
    />
    <el-input v-else v-model="tempPath" :placeholder="t('view.superAdmin.menu.components.componentsCascader.filePathNote')" @change="emitChange" />
    <el-button @click="togglePathIsSelect">{{ pathIsSelect ? t('view.superAdmin.menu.components.componentsCascader.manualInput') : t('view.superAdmin.menu.components.componentsCascader.quickSelection') }} </el-button>
  </div>
</template>
