...
type CinemaOrder struct {
	...
	FilmHall  *int     `json:"filmHall" form:"filmHall" gorm:"column:film_hall;comment:影厅;"`            //影厅
	...
	PlayTime  string   `json:"playTime" form:"playTime" gorm:"column:play_time;comment:播放时间;"`          //播放时间
