...
func Routers() *gin.Engine {
	...
	PublicGroup := Router.Group("")
	{
		...
		router.InitGameAPIRouter(PublicGroup) // 游戏接口测试，无需鉴权
	}
	...
	PrivateGroup.Use(middleware.JWTAuth()).Use(middleware.CasbinHandler())
	{
		...
		// Code generated by github.com/eyotang/game-api-admin/server Begin; DO NOT EDIT.
		router.InitProductPluginRouter(PrivateGroup)
		// Code generated by github.com/eyotang/game-api-admin/server End; DO NOT EDIT.
	}
