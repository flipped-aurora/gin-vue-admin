...
func (i *initMenu) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	allMenus := []SysBaseMenu{
		...
		{MenuLevel: 0, Hidden: false, ParentId: 0, Path: "ai", Name: "ai", Component: "view/routerHolder.vue", Sort: 6, Meta: Meta{Title: "AI 工坊", Icon: "magic-stick"}},
	...
	childMenus := []SysBaseMenu{
		...
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["ai"], Path: "mcpTool", Name: "mcpTool", Component: "plugin/ai/view/mcp/mcp.vue", Sort: 1, Meta: Meta{Title: "Mcp Tools模板", Icon: "monitor"}},
		...
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["ai"], Path: "cli", Name: "Cli", Component: "plugin/ai/view/cli/index.vue", Sort: 4, Meta: Meta{Title: "AI CLI管理", Icon: "cpu", KeepAlive: true}},
