...
// @Success 200 {object} response.Response{msg="创建成功"} "创建SysDictionary"
...
// @Produce application/json
// @Param data body system.SysDictionary true "SysDictionary模型"
// @Success 200 {object} response.Response{msg="删除成功"} "删除SysDictionary"
...
// @Produce application/json
// @Param data body system.SysDictionary true "SysDictionary模型"
// @Success 200 {object} response.Response{msg="更新成功"} "更新SysDictionary"
...
// @Success 200 {object} response.Response{data=gin.H,msg="查询成功"} "用id查询SysDictionary"
...
// @Success 200 {object} response.Response{data=response.PageResult,msg="获取成功"} "分页获取SysDictionary列表,返回包括列表,总数,页码,每页数量"
