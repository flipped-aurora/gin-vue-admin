...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/cinemaFilm/deleteCinemaFilmByIds": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/cinemaOrder/getCinemaOrderList": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/cinemaSeat/createCinemaSeat": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "创建cinemaSeat表",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.CinemaSeatCreate"
                        }
                    }
                ],
                "responses": {
        ...
        "/cinemaSeat/deleteCinemaSeat": {
            "delete": {
                ...
                "parameters": [
                    {
                        "description": "删除cinemaSeat表",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/cinema.CinemaSeat"
                        }
                    }
                ],
                "responses": {
