...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/profile/deleteCompanyProfileByIds": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "description": "批量删除CompanyProfile",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/profile/deleteUserProfileByIds": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/profile/findCompanyProfile": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "用id查询CompanyProfile",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
        ...
        "/profile/getCompanyProfileList": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "分页获取CompanyProfile列表",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
                ...
                "parameters": [
                    {
                        ...
                        "minimum": 0,
                        "type": "integer",
                        "description": "0:未参与 1:参与中 2:已完成 3:已放弃",
                        "name": "actor",
                        "in": "query"
                    },
                    {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.ProjectSearch"
                        }
                    }
                ],
                "responses": {
