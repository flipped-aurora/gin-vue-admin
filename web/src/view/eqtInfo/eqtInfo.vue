  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="设备状态" prop="eqtStatus" width="120">
            <template #default="scope">
            {{ filterDict(scope.row.eqtStatus,reservationStatusOptions) }}
            </template>
        </el-table-column>
        <el-table-column align="left" label="设备库存状态" prop="eqtStockStatus" width="120">
            <template #default="scope">
            {{ filterDict(scope.row.eqtStockStatus,eqtStockOptions) }}
            </template>
        </el-table-column>
        <el-table-column align="left" label="当前科室" prop="currentDept" width="120" />
         <el-table-column align="left" label="serviceTime" width="180">
