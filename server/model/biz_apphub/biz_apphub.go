...
func (b BizAppHub) GetUseOssPath() string {
	return fmt.Sprintf("soft/%s/%s/index.html", b.User, b.AppCode)
}

// GetUseOssPathV2 访问地址
func (b BizAppHub) GetUseOssPathV2() string {
	return fmt.Sprintf("soft/%s/%s/index", b.User, b.AppCode)
}

// GetOssStorePath 版本存储地址
func (b BizAppHub) GetOssStorePath() string {
	return fmt.Sprintf("soft/%s/%s/%s/dist/index.html", b.User, b.AppCode, b.Version)
}
